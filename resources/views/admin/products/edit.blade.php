                    ...
                    <div class="col-md-12">
                        ...
                        <form action="{{route('admin.products.update', $product->id)}}" method="post" class="w-25" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" placeholder="Продукт" name="title" value="{{$product->title}}">
                            </div>

                            <div class="form-group">
                                <label>Цена продукта</label>
                                <input type="number" min="1" step="any" class="form-control" placeholder="Цена" name="price" value="{{$product->price}}">
                            </div>

                            <div class="form-group">
                                <label for="exampleInputFile">Обновить картинку</label>
                                <img src="{{asset('storage/' . $product->image)}}" style="max-height: 225px; max-width: 375px;" />
